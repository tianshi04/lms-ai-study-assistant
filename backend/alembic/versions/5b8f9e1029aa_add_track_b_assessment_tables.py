...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_honor_code_agreements_user_id'), 'honor_code_agreements', ['user_id'], unique=False)
    op.create_index(op.f('ix_honor_code_agreements_item_id'), 'honor_code_agreements', ['item_id'], unique=False)
    ...
    op.create_index(op.f('ix_quiz_submissions_item_id'), 'quiz_submissions', ['item_id'], unique=False)
    ...
    op.create_index(op.f('ix_quiz_cooldowns_user_id'), 'quiz_cooldowns', ['user_id'], unique=False)
    op.create_index(op.f('ix_quiz_cooldowns_item_id'), 'quiz_cooldowns', ['item_id'], unique=False)
    ...
    op.create_index(op.f('ix_lab_submissions_user_id'), 'lab_submissions', ['user_id'], unique=False)
    op.create_index(op.f('ix_lab_submissions_item_id'), 'lab_submissions', ['item_id'], unique=False)
    ...
    op.create_index(op.f('ix_peer_assignment_submissions_user_id'), 'peer_assignment_submissions', ['user_id'], unique=False)
    op.create_index(op.f('ix_peer_assignment_submissions_item_id'), 'peer_assignment_submissions', ['item_id'], unique=False)
    ...
    op.create_index(op.f('ix_peer_reviews_reviewer_user_id'), 'peer_reviews', ['reviewer_user_id'], unique=False)
    op.create_index(op.f('ix_peer_reviews_item_id'), 'peer_reviews', ['item_id'], unique=False)
    ...
    op.create_index(op.f('ix_grade_appeals_user_id'), 'grade_appeals', ['user_id'], unique=False)
