...
- [Base UI](https://base-ui.com) (`@base-ui/react`) - Primary primitive library
...
- [Base UI styled components](https://base-ui.com/) (styled wrappers of Base UI primitives)
- [shadcn/ui components](https://ui.shadcn.com/) (styled wrappers of unstyled primitives)
