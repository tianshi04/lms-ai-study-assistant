...
export const LearnPageAIChatbot = forwardRef<LearnPageAIChatbotRef, LearnPageAIChatbotProps>(
  function LearnPageAIChatbot(
    {
      courseId,
      courseTitle,
    ...
    useFrontendTool({
      ...
      render: ({ args, result }) => {
        ...
        return (
          <TimestampSeekCard seconds={seconds} label={label} reason={reason} onSeek={onSeek} />
        );
      },
    });
