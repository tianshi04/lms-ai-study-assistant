...
export function GoogleAuthButton({
  ...
  return (
    <Button
      ...
      className={`w-full py-3 rounded-xl font-semibold text-sm flex items-center justify-center gap-3 border border-border bg-card hover:bg-muted/80 text-foreground transition-all shadow-sm ${className}`}
    >
