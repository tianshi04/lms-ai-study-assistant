  ...
  return (
    <div className="flex items-start gap-3">
      <BaseRadio.Root
        ...
        id={radioId}
        className={cn(
          "aspect-square h-5 w-5 rounded-full border border-input text-primary shadow focus:outline-none focus-visible:ring-2 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:border-primary flex items-center justify-center cursor-pointer transition-colors mt-0.5",
          className,
        )}
        {...props}
      >
