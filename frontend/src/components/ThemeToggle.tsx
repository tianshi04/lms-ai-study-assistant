...
export function ThemeToggle() {
  ...
  const getThemeInfo = () => {
    if (theme === "light") {
      return {
        label: "Sáng",
        title: "Giao diện: Sáng (Light Mode). Click để chuyển sang Tối.",
        icon: (
    ...
    if (theme === "dark") {
      return {
        label: "Tối",
        title: "Giao diện: Tối (Dark Mode). Click để chuyển sang Theo Hệ thống.",
        icon: (
    ...
    return {
      label: "Hệ thống",
      title: "Giao diện: Theo Cài đặt Hệ thống (System Auto). Click để chuyển sang Sáng.",
      icon: (
