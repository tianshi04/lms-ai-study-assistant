...
const defaultNavItems: NavRailItem[] = [
  ...
  { href: "/my-courses", label: "Khoá học", icon: BookOpen },
        ...
        {items.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex flex-col items-center justify-center w-full py-2.5 px-1 rounded-2xl transition-all duration-200 ease-m3-emphasized group text-center gap-1",
                isActive
            ...
            >
              <div
                className={cn(
                  "flex items-center justify-center w-12 h-7 rounded-full transition-all duration-200 ease-m3-emphasized",
