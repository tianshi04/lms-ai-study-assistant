                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    {course.partnerLogoUrl ? (
                      ...
                      <span className="text-xs font-semibold text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-500/10 px-2.5 py-1 rounded-md border border-blue-200 dark:border-blue-500/20">
                        {course.partnerName}
                      </span>
                    )}
                  </div>
