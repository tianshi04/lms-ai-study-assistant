    ...
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans selection:bg-blue-600 selection:text-white transition-colors duration-200">
      ...
      <header className="relative z-30 border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <Link
              href="/courses"
              className="text-sm font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-500 transition-colors bg-blue-50 dark:bg-blue-500/10 px-3.5 py-1.5 rounded-lg border border-blue-200 dark:border-blue-500/20 inline-flex items-center gap-2"
            >
      ...
      <main className="flex-1 relative z-20 max-w-7xl mx-auto px-6 pt-16 pb-12 text-center md:text-left grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <div className="lg:col-span-7 space-y-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 text-blue-600 dark:text-blue-400 text-xs font-semibold uppercase tracking-wider">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-tight">
            Nền tảng Học tập Thông minh Tích hợp <span className="bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 bg-clip-text text-transparent">Coursera AI Coach</span>
          </h2>
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            ...
            <Link
              ...
              className="px-6 py-3.5 rounded-xl bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200 border border-slate-200 dark:border-slate-800 font-bold text-sm transition-all flex items-center gap-2 shadow-sm"
            >
        ...
        <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">Xem danh sách khóa học Specialization theo chuẩn Coursera.</p>
          </Link>
          ...
          >
            ...
            <h3 className="font-bold text-slate-900 dark:text-white text-base mb-1 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">Interactive Player</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400">Phát Video + Interactive Transcript cuộn & In-Video Quiz.</p>
          </Link>

          <div className="p-5 rounded-2xl bg-white dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800 shadow-sm text-left">
            <div className="w-10 h-10 rounded-xl bg-amber-50 dark:bg-amber-500/10 border border-amber-100 dark:border-amber-500/20 text-amber-600 dark:text-amber-400 flex items-center justify-center mb-3">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
            <h3 className="font-bold text-slate-900 dark:text-white text-base mb-1">Reset Deadlines</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400">Gia hạn lịch nộp bài linh hoạt không trừ điểm thi.</p>
          </div>

          <div className="p-5 rounded-2xl bg-white dark:bg-slate-900/70 border border-slate-200 dark:border-slate-800 shadow-sm text-left">
            <div className="w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-100 dark:border-emerald-500/20 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mb-3">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" />
              </svg>
            </div>
            <h3 className="font-bold text-slate-900 dark:text-white text-base mb-1">Personal Notes</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400">Bôi đen bài giảng & lưu ghi chú cá nhân tức thì.</p>
          </div>
        </div>
      </main>
