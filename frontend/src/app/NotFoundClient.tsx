...
export function NotFoundClient() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans selection:bg-blue-600 selection:text-white transition-colors duration-200">
      ...
      <div className="fixed inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(14,165,233,0.08),transparent_45%),radial-gradient(circle_at_70%_70%,rgba(99,102,241,0.08),transparent_45%)] pointer-events-none" />
        ...
        <div className="space-y-8 w-full">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
            ...
            <button
              ...
              type="button"
              onClick={() => router.back()}
              className="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-transparent text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white font-semibold transition-colors duration-200"
            >
              <svg
                className="w-4 h-4"
                fill="none"
